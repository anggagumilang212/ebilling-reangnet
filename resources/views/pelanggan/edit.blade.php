                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-default">
                                                ...
                                                <select name="jenis" id="jenis" class="form-control" required>
                                                    ...
                                                    <option value="baru"
                                                        {{ $pelanggan->jenis == 'baru' ? 'selected' : '' }}>Baru</option>
                                                    <option value="lama"
                                                        {{ $pelanggan->jenis == 'lama' ? 'selected' : '' }}>Lama</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-default">
                                                ...
                                                @if ($pelanggan->ktp)
                                                    <small>File KTP saat ini: {{ basename($pelanggan->ktp) }}</small>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="input-group col-md-6">
                                            <input type="text" id="titik_koordinat" name="titik_koordinat"
                                                class="form-control" value="{{ $pelanggan->titik_koordinat }}" />
                                                ...
                                                <select name="package_id" class="form-control">
                                                    ...
                                                    @foreach ($packages as $package)
                                                        <option value="{{ $package->id }}"
                                                            {{ $pelanggan->package_id == $package->id ? 'selected' : '' }}>
                                                            {{ $package->nama }} - Rp
                                                ...
                                                <select name="router_id" id="router_id" class="form-control">
                                                    ...
                                                    @foreach ($routers as $data)
                                                        <option value="{{ $data['id'] }}"
                                                            {{ $pelanggan->router_id == $data['id'] ? 'selected' : '' }}>
                                                            {{ $data['name'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-default">
                                                ...
                                                <select name="metode" id="metode" class="form-control" required>
                                                    <option>Pilih</option>
                                                    <option value="buat_baru"
                                                        {{ $pelanggan->metode == 'buat_baru' ? 'selected' : '' }}>Buat Baru
                                                    </option>
                                                    <option value="sinkronisasi"
                                                        {{ $pelanggan->metode == 'sinkronisasi' ? 'selected' : '' }}>
                                                        Sinkronisasi</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12 sync-section"
                                            style="{{ $pelanggan->metode == 'sinkronisasi' ? '' : 'display: none;' }}">
                                            <div class="form-group form-group-default">
                                                <label>Secret</label>
                                                <select id="secret_id" class="form-control select2-container"
                                                    style="width: 100%" value="{{ $pelanggan->secret_id }}">
                                                    <option></option>
                                                </select>
                                            </div>
                                            ...
                                            <input type="hidden" id="sync_service" name="sync_service"
                                                value="{{ $pelanggan->service }}">
                                            <input type="hidden" id="sync_profile" name="sync_profile"
                                                value="{{ $pelanggan->profile }}">
                                            <input type="hidden" id="sync_local_address" name="sync_local_address"
                                                value="{{ $pelanggan->local_address }}">
                                            <input type="hidden" id="sync_remote_address" name="sync_remote_address"
                                                value="{{ $pelanggan->remote_address }}">
                                        </div>
                                        <div class="new-pppoe-section"
                                            style="{{ $pelanggan->metode == 'buat_baru' ? '' : 'display: none;' }}">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        <label>Username</label>
                                                        <input name="user" type="text" class="form-control"
                                                            value="{{ $pelanggan->username_pppoe }}" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <select name="service" id="service" class="form-control">
                                                            <option value="" disabled>Pilih</option>
                                                            <option value="any"
                                                                {{ $pelanggan->service == 'any' ? 'selected' : '' }}>ANY
                                                            </option>
                                                            <option value="async"
                                                                {{ $pelanggan->service == 'async' ? 'selected' : '' }}>
                                                                ASYNC</option>
                                                            <option value="pppoe"
                                                                {{ $pelanggan->service == 'pppoe' ? 'selected' : '' }}>
                                                                PPPoE</option>
                                                            <option value="pptp"
                                                                {{ $pelanggan->service == 'pptp' ? 'selected' : '' }}>PPTP
                                                            </option>
                                                            <option value="sstp"
                                                                {{ $pelanggan->service == 'sstp' ? 'selected' : '' }}>SSTP
                                                            </option>
                                                            <option value="l2tp"
                                                                {{ $pelanggan->service == 'l2tp' ? 'selected' : '' }}>L2TP
                                                            </option>
                                                            <option value="ovpn"
                                                                {{ $pelanggan->service == 'ovpn' ? 'selected' : '' }}>OVPN
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input name="localaddress" id="localaddress" type="text"
                                                            class="form-control" value="{{ $pelanggan->local_address }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
